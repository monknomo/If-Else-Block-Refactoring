...
public class BusinessRuleEngineTest extends BaseBusinessRuleEngineTest {
    ...
    public void typeITransferRule() {
        String error = com.gunnargissel.suemez.businessrulerefactorexample.refactor1.BusinessRulesEngine.checkWidgetTransfer(getTypeITransferRuleTransfer());
        assertEquals("Amount is too small for I type transfer. ; ", error);
    }

    @Test
    public void typeITransferTooBigRule() {
        String error = com.gunnargissel.suemez.businessrulerefactorexample.refactor1.BusinessRulesEngine.checkWidgetTransfer(getTypeITransferTooBigTransfer());
        assertEquals("This transfer is too large. ; ", error);
    }

    @Test
    public void multiError() {
        String error = com.gunnargissel.suemez.businessrulerefactorexample.refactor1.BusinessRulesEngine.checkWidgetTransfer(getMultiErrorTransfer());
